"""Hash-pin and independently check formal Claim 5 source evidence."""
...
EXPECTED_SHA256 = "e2999b9b5c407484f4af0777a5e4889ca2f9e07abc2d46048d883020959ce82c"
...
def main() -> int:
    ...
    if observed_sha256 != EXPECTED_SHA256:
        print(
            json.dumps(
                {
                    "event": "CLAIM5_SOURCE_HASH_CHECK",
                    "status": "FAIL",
